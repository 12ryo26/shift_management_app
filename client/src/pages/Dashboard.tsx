                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-left py-2">開始時間</th>
                      <th className="text-left py-2">終了時間</th>
                    </tr>
                  </thead>
                  <tbody>
                    {allRequests.map(req => (
                      <tr key={req.id} className="border-b hover:bg-gray-50">
                        ...
                        <td className="py-2">
                          {req.requestType === "work" ? "出勤" : req.requestType === "off" ? "休み" : "相談"}
                        </td>
                        <td className="py-2">{req.preferredStartTime || "-"}</td>
                        <td className="py-2">{req.preferredEndTime || "-"}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
